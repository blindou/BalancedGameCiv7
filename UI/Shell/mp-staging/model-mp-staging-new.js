...
export class MPLobbyDataModel {
    ...
    constructor() {
        ...
        this.PlayerMementoMinorSlot2StringHandle = GameSetup.makeString('PlayerMementoMinorSlot2');
                ...
                if (playerConfig.isParticipant) {
                    ...
                    if (gameConfig.isMementosEnabled && isHuman) {
                        mementos = [
                            ...
                            this.findPlayerParameter(curPlayerID, this.PlayerMementoMinorSlot2StringHandle)?.value.value,
                        ];
                    }
                }

...
UPDATE LocalizedText
SET Text = '[BLIST][LI][B]+2 [icon:YIELD_PRODUCTION] Production [/B]in the [icon:NOTIFICATION_SELECT_CAPITAL] [B]Capital [/B]for every [icon:YIELD_TOWNS] [B]Town[/B].[LI]Can purchase [icon:YIELD_CULTURE] [B]Culture Buildings [/B]in [icon:YIELD_TOWNS] [B]Towns[/B].[LI][B]+50% [icon:YIELD_GOLD] Gold [/B]towards purchasing Buildings in [icon:YIELD_TOWNS] [B]Towns[/B].[/LIST]'
...
UPDATE LocalizedText
SET Text = '[BLIST][LI][B]+2 [icon:YIELD_CULTURE] Culture [/B]per Age on displayed [icon:GREATWORK] [B]Great Works[/B].[LI]Buildings with [icon:GREATWORK] [B]Great Work [/B]slots gain [B]1 additional slot[/B].[LI][icon:YIELD_CITIES] Cities settled in [B]Tundra [/B]gain [icon:YIELD_SCIENCE] [B]Science [/B]equal to [B]25% [/B]of their [icon:YIELD_CULTURE] [B]Culture [/B]per turn.[LI][B]BIAS :[/B] T1 Tundra.[/LIST]'
WHERE Tag = 'LOC_TRAIT_LEADER_CATHERINE_ABILITY_DESCRIPTION' AND Language = 'en_US';

-- Charlemagne

UPDATE LocalizedText
SET Text = '[icon:DIPLOMACY_DECLARE_FORMAL_WAR_ICON] Military and [icon:YIELD_SCIENCE] Science Buildings receive a +1 [icon:YIELD_HAPPINESS] Happiness Adjacency for [icon:CITY_URBAN] Quarters. Gain 2 free Cavalry Units, once unlocked, when entering a [icon:CELEBRATION] Celebration. +5 [icon:NAR_REW_COMBAT] Combat Strength for Cavalry Units during a [icon:CELEBRATION] Celebration. BIAS : T4 Grasslands.'
WHERE Tag = 'LOC_LEADER_CHARLEMAGNE_DESCRIPTION' AND Language = 'en_US';

UPDATE LocalizedText
SET Text = '[BLIST][LI][B][icon:WAR] Military [/B]and [icon:YIELD_SCIENCE] [B]Science Buildings [/B]receive a [B]+1 [icon:YIELD_HAPPINESS] Happiness Adjacency [/B]for [icon:CITY_URBAN] [B]Quarters[/B].[LI]Gain [B]2 free Cavalry Units[/B], once unlocked, when entering a [icon:CELEBRATION] [B]Celebration[/B].[LI][B]+5 [icon:NAR_REW_COMBAT] Combat Strength[/B] for [B]Cavalry Units [/B]during a [icon:CELEBRATION] [B]Celebration[/B].[LI][B]BIAS :[/B] T4 Grasslands.[/LIST]'
WHERE Tag = 'LOC_TRAIT_LEADER_CHARLEMAGNE_ABILITY_DESCRIPTION' AND Language = 'en_US';

-- Confucius

UPDATE LocalizedText
SET Text = '+25% Growth Rate in [icon:YIELD_CITIES] Cities. +2 [icon:YIELD_SCIENCE] Science from [icon:SPECIALIST] Specialists. BIAS : T4 River.'
...
UPDATE LocalizedText
SET Text = '[BLIST][LI][B]+100% [icon:YIELD_DIPLOMACY] Influence [/B]towards initiating [icon:ESPIONAGE] [B]Espionage Actions[/B].[LI]Gain [B]5 [icon:WAR_SUPPORT] War Support [/B]on all wars declared against you.[LI]Units ignore [icon:Action_Move] [B]Movement penalties [/B]from [B]Vegetation[/B].[LI][B]BIAS :[/B] T4 Vegetated.[/LIST]'
...
UPDATE LocalizedText
SET Text = '+1[icon:YIELD_PRODUCTION] Production for every 5 excess [icon:YIELD_HAPPINESS] Happiness in [icon:YIELD_CITIES] Cities. +10% [icon:YIELD_PRODUCTION] Production in Settlements not founded by you. Declaring a [icon:WAR] Formal War grants a [icon:NOTIFICATION_CHOOSE_GOLDEN_AGE] Celebration. +5 [icon:NAR_REW_COMBAT] Combat Strength against [icon:CITY_URBAN] Districts for all Units during a [icon:NOTIFICATION_CHOOSE_GOLDEN_AGE] Celebration.'
WHERE Tag = 'LOC_LEADER_ASHOKA_ALT_DESCRIPTION' AND Language = 'en_US';

UPDATE LocalizedText
SET Text = '[BLIST][LI][B]+1[icon:YIELD_PRODUCTION] Production [/B]for every [B]5 [/B]excess [icon:YIELD_HAPPINESS] [B]Happiness [/B]in [icon:YIELD_CITIES] [B]Cities[/B].[LI][B]+10% [icon:YIELD_PRODUCTION] Production [/B]in Settlements not founded by you.[LI]Declaring a [icon:WAR] [B]Formal War [/B]grants a [icon:NOTIFICATION_CHOOSE_GOLDEN_AGE] [B]Celebration[/B].[LI][B]+5 [icon:NAR_REW_COMBAT] Combat Strength[/B] against [icon:CITY_URBAN] [B]Districts [/B]for all Units during a [icon:NOTIFICATION_CHOOSE_GOLDEN_AGE] [B]Celebration[/B].[/LIST]'
WHERE Tag = 'LOC_TRAIT_LEADER_ASHOKA_ALT_ABILITY_DESCRIPTION' AND Language = 'en_US';

-- Himiko, High Shaman

UPDATE LocalizedText
SET Text = '+2 [icon:YIELD_HAPPINESS] Happiness per Age on [icon:YIELD_HAPPINESS] Happiness and [icon:YIELD_DIPLOMACY] Influence Buildings, doubled if a Building is both. +50% [icon:YIELD_PRODUCTION] Production towards constructing [icon:YIELD_HAPPINESS] Happiness and [icon:YIELD_DIPLOMACY] Influence Buildings, doubled if a Building is both. +20% [icon:YIELD_CULTURE] Culture but -10% [icon:YIELD_SCIENCE] Science, and these effects are doubled while in a [icon:NOTIFICATION_CHOOSE_GOLDEN_AGE] Celebration.'
WHERE Tag = 'LOC_LEADER_HIMIKO_ALT_DESCRIPTION' AND Language = 'en_US';

UPDATE LocalizedText
SET Text = '[BLIST][LI][B]+2 [icon:YIELD_HAPPINESS] Happiness [/B]per Age on [icon:YIELD_HAPPINESS] [B]Happiness [/B]and [icon:YIELD_DIPLOMACY] [B]Influence Buildings[/B], doubled if a [B]Building[/B] is both.[LI][B]+50% [icon:YIELD_PRODUCTION] Production [/B]towards constructing [icon:YIELD_HAPPINESS] [B]Happiness[/B] and [icon:YIELD_DIPLOMACY] [B]Influence Buildings[/B], doubled if a [B]Building[/B] is both.[LI][B]+20% [icon:YIELD_CULTURE] Culture [/B]but [B]-10% [icon:YIELD_SCIENCE] Science[/B], and these effects are [B]doubled [/B]while in a [icon:NOTIFICATION_CHOOSE_GOLDEN_AGE] [B]Celebration[/B].[/LIST]'
...
INSERT OR REPLACE INTO LocalizedText
        ...
        ('en_US', 'LOC_ABILITY_FRIEDRICH_CULTURAL_INFANTRY_DESCRIPTION', '+5 Combat Strength for infantry units trained through culture buildings.');

-- Xerxes ALT

UPDATE LocalizedText
SET Text = '+1 [icon:TRADE_ROUTE] Trade Route limit per Age with all other Leaders. +10 Trade Range. Gain 50 [icon:YIELD_CULTURE] Culture and 100 [icon:YIELD_GOLD] Gold per Age when you create a Trade Route or Road. +1 [icon:YIELD_CULTURE] Culture and [icon:YIELD_GOLD] Gold per Age on Unique Buildings and Improvements. BIAS : T4 Desert.'
...
UPDATE LocalizedText
SET Text = '+2[icon:YIELD_GOLD] Gold on Resources. Bias : T1 coastal.'
...
UPDATE LocalizedText
SET Text = 'Can only have 1 City. Towns cannot use Convert to City. Receive a second Merchant or Colonist each time you purchase or train one. Bias : T1 coastal.'
...
UPDATE LocalizedText
SET Text = '+3 [icon:YIELD_DIPLOMACY] Influence per turn on the Palace. Bias: T2 rough terrain.'
...
WHERE Tag = 'LOC_TRAIT_EGYPT_ABILITY_DESCRIPTION' and Language = 'en_US';
...
WHERE Tag = 'LOC_QUARTER_NECROPOLIS_DESCRIPTION' and Language = 'en_US';
...
WHERE Tag = 'LOC_TRAIT_HAN_ABILITY_DESCRIPTION' and Language = 'en_US';
...
WHERE Tag = 'LOC_TRAIT_KHMER_ABILITY_DESCRIPTION' and Language = 'en_US';

UPDATE LocalizedText
SET Text = 'Districts on Rivers do not remove the natural yield of the tile. BIAS: T1 Floodplain.[/LIST]'
...
WHERE Tag = 'LOC_TRAIT_MAYA_ABILITY_DESCRIPTION' and Language = 'en_US';

UPDATE LocalizedText
SET Text = 'The Palace gains +0.5 [icon:YIELD_SCIENCE] Science for adjacent Vegetated Terrain. BIAS: T2 Vegetation + T3 Tropical.'
WHERE Tag = 'LOC_CIVILIZATION_MAYA_DESCRIPTION' and Language = 'en_US';

UPDATE LocalizedText
SET Text = 'Maya Unique Quarter. Created by constructing the Jalaw and K''uh Nah in the same District. Every time you research a [icon:RADIAL_TECH] Technology, this Settlement gains 13 [icon:YIELD_PRODUCTION] Production in Antiquity, 26 [icon:YIELD_PRODUCTION] in Exploration and 52 [icon:YIELD_PRODUCTION] in Modern.'
...
WHERE Tag = 'LOC_TRAIT_MAURYA_ABILITY_DESCRIPTION' and Language = 'en_US';
...
UPDATE LocalizedText
SET Text = 'All Buildings receive a +1 [icon:YIELD_FOOD] Food Adjacency for Resources. BIAS: T3 River + T4 Grasslands.'
...
UPDATE LocalizedText
SET Text = 'Infantry Units receive +3 Combat Strength when attacking. BIAS : T4 Desert.'
...
UPDATE LocalizedText
SET Text = '+2[icon:YIELD_CULTURE] Culture and +2[icon:YIELD_SCIENCE] Science on Districts in Tundra.'
where Tag = 'LOC_CIVILIZATION_RUSSIA_DESCRIPTION' and Language = 'en_US';

UPDATE LocalizedText
SET Text = '[BLIST][LI][B]+2 [icon:YIELD_CULTURE] Culture [/B]and [B]+2 [icon:YIELD_SCIENCE] Science [/B]on [B]Districts[/B] in [B]Tundra[/B].[LI][B]+30% [icon:YIELD_PRODUCTION] Production [/B]towards constructing the [B]Hermitage[/B].[/LIST]'
where Tag = 'LOC_TRAIT_RUSSIA_ABILITY_DESCRIPTION' and Language = 'en_US';

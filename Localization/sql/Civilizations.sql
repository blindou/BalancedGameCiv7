...
UPDATE LocalizedText
SET Text = '+60% [icon:YIELD_GOLD] Gold from [icon:PROJECT_TOWN_PRODUCTION] Mining [icon:YIELD_TOWNS] Towns. +60% [icon:YIELD_FOOD] Food from [icon:PROJECT_TOWN_FISHING] Fishing or Farming [icon:YIELD_TOWNS] Towns.'
